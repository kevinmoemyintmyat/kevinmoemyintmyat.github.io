...
Aside from that, I enjoy writing blogs and articles. Every now and then, I sing karaoke 🎤 on Smule and also experiment with cooking recipes 🧑‍🍳 which are available on my TikTok.
` },
        {
            name: "keywords",
            content: `Kevin Moe Myint Myat,kevinmoemyintmyat,kevinmoemyintmyat.github.io,blog, stories, software developer, artist, cat dad,fullstack,software,kevin,moe,myint,myat,kevn,Kevn Moe Myint Myat,KevinMoeMyintMyat, Kevin Moe Myint Myat, Github, art, travel blogs, articles, music`,
        },
        {
            property: "og:title",
