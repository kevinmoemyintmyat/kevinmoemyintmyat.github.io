...
useHead({
  title:
    `မှတ်မိနေမည် မနီလာ အပိုင်း(၁) - Written by Kevin Moe Myint Myat` ||
  ...
  meta: [
    ...
    {
      name: "keywords",
      content: `manila,manila memories,part-1,part-one,travel, Kevin Moe Myint Myat,kevinmoemyintmyat,kevinmoemyintmyat.github.io,blog, stories, software developer, artist, cat dad,fullstack,software,kevin,moe,myint,myat,kevn,Kevn Moe Myint Myat,KevinMoeMyintMyat, Kevin Moe Myint Myat, Github, art`,
    },
    {
      property: "og:title",
