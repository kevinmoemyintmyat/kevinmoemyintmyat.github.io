<template>
    <section class="mt-20 lg:pl-20 p-5" ref="startOfArticle">
        ...
        <p>On 11th November 2022 , It was a great morning before the flight. I woke up fresh and felt ready to start the
            day.
            I already packed my luggage and my backpack.
            I went to the nearby restaurant to have a soup for my breakfast to soothe my hunger.
        ...
        <p class="mt-10">
            It took around 3 hours to arrive from Singapore to Bali Ngurah Rai Airport. It was marvellous and I was
            super excited to land on the Bali island for the first time. You know what, I was listening to Beach vibe
            ...
            To describe the Damperser airport, it is decorated with ancient Balinese architecture. The gate looks pretty
        ...
        <p class="mt-10">
            It's already late when I arrived in Bali, around 7-8 PM. I booked a Grab taxi and went to my hotel which is
            in Kuta.
            To be exact, it's near Jalan Kartika Plaza. The ride from the airport to my hotel is breathtaking. The new
            scenary makes me feel
            ...
            After I've unpacked my stuffs and laptops, I listened to some music and take a nap....
        </p>
        <p class="mt-10">
            I woke up again after resting for awhile and beating the jetlag.
            Since I'm on a tight schedule and it's just a 3-day-2-night vacation, I quickly wrote a travel plan on a
            note that was given at the hotel room.
            I googled and listed down some of the great tourist attractions that I can visit in Bali.
            It was like this.
        </p>
        <ul class="list-disc pl-10 pt-10 text-xl font-bold">
            <li @click="showSection('seminyakBeach')">
        ...
        <p class="pt-10">
            After listing down my travel plan, I walked out of the resort to start roaming around the night of Jalan
            Kartika Plaza.
            Just right out of my hotel, there were many shops, bars and tattoo parlours. It is truly amazing to see the
            colorful actions of
            ...
            rested for awhile.
            After I have my satisfying ride, I was a bit hungry and I saw a street store selling Satays. I bought a
            packet of satay to bring back to the hotel and enjoyed for myself. They only costs around a few rupiahs.
        ...
        <div class="pt-10" ref="seminyakBeach">
            <h2>Next morning to the Seminyak beach</h2>
            <p>
                After a night of sound sleep, I woke up to the wonderful sounds of singing birds around the hotel.
                Around the hotel, I saw lots of statues resembling the tiny gods of the island and a Garuda statue too
                (Garuda which is an icon of Indonesia and an emblem as well).
                I prepared for swimming because I just needed that vitamin-sea by now. I swam in the Pantai Jerman which
                ...
                Seminyak beach.
                Here we can see the difference between Kuta beach and Seminyak. Seminyak mostly have more of beach
                enjoyers, surfers and ministores along the beaches.
                I can see lots of sunbeds and small chairs given by the respective stores for the tourist to relax and
                chill.
                I had some coconut water for myself to cool down from the heat of the sun.
                <br />
                <video controls>
                    <source src="/blog/first-trip-to-bali/the-shores-of-seminyak.mp4" type="video/mp4">
                </video>
                <br />
                I spent most of the day roaming around the west coast of the Southern Bali, eating local foods like Babi
                Guling and Nasi Campur.
                And while the sun is setting, I came back to the resort and prepared for the tattoo session which is
                scheduled at 9pm.
                The tattoo studio is truly professional and went through all the great steps of printing the stencil of
                my design, measuring the area that is going to be
                inked and working on the size. The price was also pretty affordable and I also asked for a quicker
                session because I have the plan to see the nightlife of Bali at Legian street.
                As one might have guessed, yes.. it is a Garuda on my chest.
                <br />
        ...
        <div class="pt-10" ref="jalanLegian">
            <p>
                After the tattoo session, I rode to the famous Jalan Legian where I've heard most of the nightlife
                scenes in
                Bali are happening.
                The whole Jalan Legian was pretty packed with traffic, bars and clubs. It's mesmerizing to see the
                tourists
                ; enjoying and partying their time in Bali.
                <br />
            </p>
            <!--video controls>
                <source src="/blog/first-trip-to-bali/legian-street-at-night.mp4" type="video/mp4">
            </video-->
            <br />
            <p>
