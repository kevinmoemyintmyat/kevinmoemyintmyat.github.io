<template>
  <section class="mt-20 lg:pl-20 p-5 lg:ml-20 lg:w-4/6" ref="startOfArticle">
    ...
    <img class="cover-image" src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fliw75hbrte70vgzwwmhy.png" alt="Screenshot of FTP Seer API and Client Google SEO result" />
...
useHead({
  title:
    `FTP Seer API + FTP Seer Client Google SEO - Written by Kevin Moe Myint Myat` ||
  ...
  link: [
    ...
    {
      rel: "canonical",
      href: "https://kevinmoemyintmyat.github.io/blog/ftp-seer-api-ftp-seer-client-google-seo-3lf2"
    }
  ],
  meta: [
    {
...
const jsonLd = {
  ...
  "@type": "BlogPosting",
  "headline": "FTP Seer API + FTP Seer Client Google SEO",
  "description": "FTP Seer API + FTP Seer Client Google SEO - Written by Kevin Moe Myint Myat",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://kevinmoemyintmyat.github.io/blog/ftp-seer-api-ftp-seer-client-google-seo-3lf2"
  },
  "image": [
