<template>
  <section class="mt-20 lg:pl-20 p-5 lg:ml-20 lg:w-4/6" ref="startOfArticle">
    ...
    <img class="cover-image" src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fi%2Fnisypnnl5ktwlvbdx1pp.png" alt="Screenshot of Krescent game for Github Game Off 2020" />
...
useHead({
  title:
    `👾 Krescent - My experience on participating Github Game Off 2020 Game Jam on Itch.io 👾 - Written by Kevin Moe Myint Myat` ||
  ...
  link: [
    ...
    {
      rel: "canonical",
      href: "https://kevinmoemyintmyat.github.io/blog/my-experience-on-participating-github-game-off-2020-game-jam-on-itch-io-4dff"
    }
  ],
  meta: [
    {
...
const jsonLd = {
  ...
  "@type": "BlogPosting",
  "headline": "Krescent - My experience on participating Github Game Off 2020 Game Jam on Itch.io",
  "description": "Krescent - My experience on participating Github Game Off 2020 Game Jam on Itch.io - Written by Kevin Moe Myint Myat",
  "author": {
    "@type": "Person",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://kevinmoemyintmyat.github.io/blog/my-experience-on-participating-github-game-off-2020-game-jam-on-itch-io-4dff"
  },
  "image": [
